  ...
  <div id="header" class="container">
	...
	<div class="box3">
      ...
      <div id="menu" style="height:50px">
			...
			<li id="장소별검색" onClick="locationHref(this);" style="cursor:hand;"><p>장소별 검색</p></li>
		</ul>
    </div>
</div>
					...
					<div class="als-viewport">
					  <ul class="als-wrapper">
						  <li class="als-item">
							...
							<img src="categoryimg/bt.JPG" style="width: 100%; max-width: 200px; height:100%; max-height:270px;"/>
							코스를 등록해 주세요
							</a>
						  </li>
						  <li class="als-item">
